...
See our [Support
Guide](https://github.com/devops-roast/.github/blob/main/SUPPORT.md). In short,
...
Review our [Security
Policy](https://github.com/devops-roast/.github/blob/main/SECURITY.md). **Do not**
...
- **Review the documentation and [Support
  Guide](https://github.com/devops-roast/.github/blob/main/SUPPORT.md)** before
  opening a new issue.
